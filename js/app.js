...
function updateActiveSourceUI() {
  ...
  if (sourceId === 'all') {
    ...
    DOM.sourceCardSubtitle.textContent = 'Ley 16/1985 (T. VII) • Ley 10/2007 • Ley 23/2011 • RD 635/2015 • Ley 3/2011 • Decreto 33/2018 • Reglamento Albacete 2022';
    DOM.metaPillRef.textContent = '📚 7 Fuentes Normativas';
